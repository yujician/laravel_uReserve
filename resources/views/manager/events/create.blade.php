        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('events.store') }}">
                    ...
                    <div>
                        <x-jet-label for="events_name" value="イベント名" />
                        <x-jet-input id="events_name" class="block mt-1 w-full" type="text" name="event_name" :value="old('event_name')" required autofocus />
                    </div>
                    <div class="mt-4">
